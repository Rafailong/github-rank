...
object EnterprisePendingCollaboratorEdge {
  ...
  /** A cursor for use in pagination.
    */
  def cursor: SelectionBuilder[EnterprisePendingCollaboratorEdge, String] = _root_.caliban.client.SelectionBuilder.Field("cursor", Scalar())

  /** Whether the invited collaborator does not have a license for the enterprise.
    */
  @deprecated("All pending collaborators consume a license Removal on 2021-01-01 UTC.", "")
  def isUnlicensed: SelectionBuilder[EnterprisePendingCollaboratorEdge, Boolean] =
    _root_.caliban.client.SelectionBuilder.Field("isUnlicensed", Scalar())

  /** The item at the end of the edge.
    */
  def node[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[EnterprisePendingCollaboratorEdge, Option[A]] =
  ...
  ): SelectionBuilder[EnterprisePendingCollaboratorEdge, A] = _root_.caliban.client.SelectionBuilder.Field(
    "repositories",
    Obj(innerSelection),
    arguments = List(
