...
object EnterpriseAdministratorInvitationConnection {
  ...
  /** A list of edges.
    */
  def edges[A](
    innerSelection: SelectionBuilder[EnterpriseAdministratorInvitationEdge, A]
  ): SelectionBuilder[EnterpriseAdministratorInvitationConnection, Option[List[Option[A]]]] =
  ...
  /** Information to aid in pagination.
    */
  def pageInfo[A](innerSelection: SelectionBuilder[PageInfo, A]): SelectionBuilder[EnterpriseAdministratorInvitationConnection, A] =
    _root_.caliban.client.SelectionBuilder.Field("pageInfo", Obj(innerSelection))

  /** Identifies the total count of items in the connection.
    */
  def totalCount: SelectionBuilder[EnterpriseAdministratorInvitationConnection, Int] =
