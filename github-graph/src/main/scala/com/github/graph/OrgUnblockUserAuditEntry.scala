...
object OrgUnblockUserAuditEntry {
  ...
  ): SelectionBuilder[OrgUnblockUserAuditEntry, Option[A]] = _root_.caliban.client.SelectionBuilder
  ...
  /** A readable representation of the actor's location
    */
  def actorLocation[A](innerSelection: SelectionBuilder[ActorLocation, A]): SelectionBuilder[OrgUnblockUserAuditEntry, Option[A]] =
  ...
  /** The HTTP path for the actor.
    */
  def actorResourcePath: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("actorResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the actor.
    */
  def actorUrl: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("actorUrl", OptionOf(Scalar()))

  /** The user being unblocked by the organization.
    */
  def blockedUser[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[OrgUnblockUserAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("blockedUser", OptionOf(Obj(innerSelection)))

  /** The username of the blocked user.
    */
  def blockedUserName: SelectionBuilder[OrgUnblockUserAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("blockedUserName", OptionOf(Scalar()))

  /** The HTTP path for the blocked user.
    */
  def blockedUserResourcePath: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("blockedUserResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the blocked user.
    */
  def blockedUserUrl: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("blockedUserUrl", OptionOf(Scalar()))
  ...
  /** The corresponding operation type for the action
    */
  def operationType: SelectionBuilder[OrgUnblockUserAuditEntry, Option[OperationType]] =
    _root_.caliban.client.SelectionBuilder.Field("operationType", OptionOf(Scalar()))

  /** The Organization associated with the Audit Entry.
    */
  def organization[A](innerSelection: SelectionBuilder[Organization, A]): SelectionBuilder[OrgUnblockUserAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("organization", OptionOf(Obj(innerSelection)))

  /** The name of the Organization.
    */
  def organizationName: SelectionBuilder[OrgUnblockUserAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationName", OptionOf(Scalar()))

  /** The HTTP path for the organization
    */
  def organizationResourcePath: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the organization
    */
  def organizationUrl: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationUrl", OptionOf(Scalar()))

  /** The user affected by the action
    */
  def user[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[OrgUnblockUserAuditEntry, Option[A]] =
  ...
  /** The HTTP path for the user.
    */
  def userResourcePath: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("userResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the user.
    */
  def userUrl: SelectionBuilder[OrgUnblockUserAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("userUrl", OptionOf(Scalar()))
  ...
  ): SelectionBuilder[OrgUnblockUserAuditEntry, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
