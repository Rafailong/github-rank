...
object RepoCreateAuditEntry {
  ...
  ): SelectionBuilder[RepoCreateAuditEntry, Option[A]] = _root_.caliban.client.SelectionBuilder
    .Field("actor", OptionOf(ChoiceOf(Map("Bot" -> Obj(onBot), "Organization" -> Obj(onOrganization), "User" -> Obj(onUser)))))

  /** The IP address of the actor
    */
  def actorIp: SelectionBuilder[RepoCreateAuditEntry, Option[String]] = _root_.caliban.client.SelectionBuilder.Field("actorIp", OptionOf(Scalar()))

  /** A readable representation of the actor's location
    */
  def actorLocation[A](innerSelection: SelectionBuilder[ActorLocation, A]): SelectionBuilder[RepoCreateAuditEntry, Option[A]] =
  ...
  /** The HTTP URL for the actor.
    */
  def actorUrl: SelectionBuilder[RepoCreateAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("actorUrl", OptionOf(Scalar()))
  ...
  def forkParentName: SelectionBuilder[RepoCreateAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("forkParentName", OptionOf(Scalar()))

  /** The name of the root repository for this network.
    */
  def forkSourceName: SelectionBuilder[RepoCreateAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("forkSourceName", OptionOf(Scalar()))
  def id: SelectionBuilder[RepoCreateAuditEntry, String] = _root_.caliban.client.SelectionBuilder.Field("id", Scalar())

  /** The corresponding operation type for the action
    */
  def operationType: SelectionBuilder[RepoCreateAuditEntry, Option[OperationType]] =
    _root_.caliban.client.SelectionBuilder.Field("operationType", OptionOf(Scalar()))

  /** The Organization associated with the Audit Entry.
    */
  def organization[A](innerSelection: SelectionBuilder[Organization, A]): SelectionBuilder[RepoCreateAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("organization", OptionOf(Obj(innerSelection)))

  /** The name of the Organization.
    */
  def organizationName: SelectionBuilder[RepoCreateAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationName", OptionOf(Scalar()))

  /** The HTTP path for the organization
    */
  def organizationResourcePath: SelectionBuilder[RepoCreateAuditEntry, Option[URI]] =
  ...
  /** The repository associated with the action
    */
  def repository[A](innerSelection: SelectionBuilder[Repository, A]): SelectionBuilder[RepoCreateAuditEntry, Option[A]] =
  ...
  /** The HTTP path for the repository
    */
  def repositoryResourcePath: SelectionBuilder[RepoCreateAuditEntry, Option[URI]] =
  ...
  /** The user affected by the action
    */
  def user[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[RepoCreateAuditEntry, Option[A]] =
  ...
  /** The HTTP URL for the user.
    */
  def userUrl: SelectionBuilder[RepoCreateAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("userUrl", OptionOf(Scalar()))

  /** The visibility of the repository
    */
  def visibility: SelectionBuilder[RepoCreateAuditEntry, Option[RepoCreateAuditEntryVisibility]] =
  ...
  ): SelectionBuilder[RepoCreateAuditEntry, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
