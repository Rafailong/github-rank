...
object UnmarkedAsDuplicateEvent {
  ...
  ): SelectionBuilder[UnmarkedAsDuplicateEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  ): SelectionBuilder[UnmarkedAsDuplicateEvent, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "canonical",
    OptionOf(
      ChoiceOf(
        Map(
