...
object IssueComment {
  ...
  ): SelectionBuilder[IssueComment, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "author",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Author's association with the subject of the comment.
    */
  def authorAssociation: SelectionBuilder[IssueComment, CommentAuthorAssociation] =
  ...
  /** Identifies the primary key from the database.
    */
  def databaseId: SelectionBuilder[IssueComment, Option[Int]] = _root_.caliban.client.SelectionBuilder.Field("databaseId", OptionOf(Scalar()))
  ...
  /** Identifies the issue associated with the comment.
    */
  def issue[A](innerSelection: SelectionBuilder[Issue, A]): SelectionBuilder[IssueComment, A] =
  ...
  /** Identifies when the comment was published at.
    */
  def publishedAt: SelectionBuilder[IssueComment, Option[DateTime]] = _root_.caliban.client.SelectionBuilder.Field("publishedAt", OptionOf(Scalar()))

  /** Returns the pull request associated with the comment, if this comment was made on a
    * pull request.
    */
  def pullRequest[A](innerSelection: SelectionBuilder[PullRequest, A]): SelectionBuilder[IssueComment, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("pullRequest", OptionOf(Obj(innerSelection)))

  /** A list of reactions grouped by content left on the subject.
    */
  def reactionGroups[A](innerSelection: SelectionBuilder[ReactionGroup, A]): SelectionBuilder[IssueComment, Option[List[A]]] =
  ...
  ): SelectionBuilder[IssueComment, A] = _root_.caliban.client.SelectionBuilder.Field(
    "reactions",
    Obj(innerSelection),
    arguments = List(
  ...
  /** The repository associated with this node.
    */
  def repository[A](innerSelection: SelectionBuilder[Repository, A]): SelectionBuilder[IssueComment, A] =
  ...
  /** Reasons why the current viewer can not update this comment.
    */
  def viewerCannotUpdateReasons: SelectionBuilder[IssueComment, List[CommentCannotUpdateReason]] =
