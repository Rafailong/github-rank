...
object CommitComment {
  ...
  ): SelectionBuilder[CommitComment, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "author",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Identifies the primary key from the database.
    */
  def databaseId: SelectionBuilder[CommitComment, Option[Int]] = _root_.caliban.client.SelectionBuilder.Field("databaseId", OptionOf(Scalar()))
  ...
  /** Identifies the file path associated with the comment.
    */
  def path: SelectionBuilder[CommitComment, Option[String]] = _root_.caliban.client.SelectionBuilder.Field("path", OptionOf(Scalar()))

  /** Identifies the line position associated with the comment.
    */
  def position: SelectionBuilder[CommitComment, Option[Int]] = _root_.caliban.client.SelectionBuilder.Field("position", OptionOf(Scalar()))

  /** Identifies when the comment was published at.
    */
  def publishedAt: SelectionBuilder[CommitComment, Option[DateTime]] = _root_.caliban.client.SelectionBuilder.Field("publishedAt", OptionOf(Scalar()))
  ...
  ): SelectionBuilder[CommitComment, A] = _root_.caliban.client.SelectionBuilder.Field(
    "reactions",
    Obj(innerSelection),
    arguments = List(
