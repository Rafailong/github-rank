...
object EnterpriseServerUserAccountConnection {
  ...
  ): SelectionBuilder[EnterpriseServerUserAccountConnection, Option[List[Option[A]]]] =
  ...
  /** Information to aid in pagination.
    */
  def pageInfo[A](innerSelection: SelectionBuilder[PageInfo, A]): SelectionBuilder[EnterpriseServerUserAccountConnection, A] =
