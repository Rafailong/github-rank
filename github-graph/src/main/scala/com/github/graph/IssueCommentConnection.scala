...
object IssueCommentConnection {
  ...
  /** A list of edges.
    */
  def edges[A](innerSelection: SelectionBuilder[IssueCommentEdge, A]): SelectionBuilder[IssueCommentConnection, Option[List[Option[A]]]] =
    _root_.caliban.client.SelectionBuilder.Field("edges", OptionOf(ListOf(OptionOf(Obj(innerSelection)))))

  /** A list of nodes.
    */
  def nodes[A](innerSelection: SelectionBuilder[IssueComment, A]): SelectionBuilder[IssueCommentConnection, Option[List[Option[A]]]] =
