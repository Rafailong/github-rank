...
object BaseRefForcePushedEvent {
  ...
  ): SelectionBuilder[BaseRefForcePushedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Identifies the after commit SHA for the 'base_ref_force_pushed' event.
    */
  def afterCommit[A](innerSelection: SelectionBuilder[Commit, A]): SelectionBuilder[BaseRefForcePushedEvent, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("afterCommit", OptionOf(Obj(innerSelection)))

  /** Identifies the before commit SHA for the 'base_ref_force_pushed' event.
    */
  def beforeCommit[A](innerSelection: SelectionBuilder[Commit, A]): SelectionBuilder[BaseRefForcePushedEvent, Option[A]] =
  ...
  /** PullRequest referenced by event.
    */
  def pullRequest[A](innerSelection: SelectionBuilder[PullRequest, A]): SelectionBuilder[BaseRefForcePushedEvent, A] =
    _root_.caliban.client.SelectionBuilder.Field("pullRequest", Obj(innerSelection))

  /** Identifies the fully qualified ref name for the 'base_ref_force_pushed' event.
    */
  def ref[A](innerSelection: SelectionBuilder[Ref, A]): SelectionBuilder[BaseRefForcePushedEvent, Option[A]] =
