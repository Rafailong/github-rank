...
object ReviewRequestedEvent {
  ...
  ): SelectionBuilder[ReviewRequestedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** PullRequest referenced by event.
    */
  def pullRequest[A](innerSelection: SelectionBuilder[PullRequest, A]): SelectionBuilder[ReviewRequestedEvent, A] =
  ...
  ): SelectionBuilder[ReviewRequestedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder
  ...
  def requestedReviewerOption[A](
    ...
    onUser: Option[SelectionBuilder[User, A]]           = None
  ): SelectionBuilder[ReviewRequestedEvent, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "requestedReviewer",
    OptionOf(
      ChoiceOf(
        Map(
