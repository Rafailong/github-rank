...
object ReadyForReviewEvent {
  ...
  ): SelectionBuilder[ReadyForReviewEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** PullRequest referenced by event.
    */
  def pullRequest[A](innerSelection: SelectionBuilder[PullRequest, A]): SelectionBuilder[ReadyForReviewEvent, A] =
