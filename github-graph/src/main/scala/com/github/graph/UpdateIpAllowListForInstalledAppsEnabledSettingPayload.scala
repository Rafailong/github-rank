...
object UpdateIpAllowListForInstalledAppsEnabledSettingPayload {
  ...
  /** A unique identifier for the client performing the mutation.
    */
  def clientMutationId: SelectionBuilder[UpdateIpAllowListForInstalledAppsEnabledSettingPayload, Option[String]] =
  ...
  ): SelectionBuilder[UpdateIpAllowListForInstalledAppsEnabledSettingPayload, Option[A]] = _root_.caliban.client.SelectionBuilder
  ...
  ): SelectionBuilder[UpdateIpAllowListForInstalledAppsEnabledSettingPayload, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "owner",
    OptionOf(
      ChoiceOf(
        Map(
