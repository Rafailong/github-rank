...
object AutoSquashEnabledEvent {
  ...
  ): SelectionBuilder[AutoSquashEnabledEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** The user who enabled auto-merge (squash) for this Pull Request
    */
  def enabler[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[AutoSquashEnabledEvent, Option[A]] =
  ...
  /** PullRequest referenced by event.
    */
  def pullRequest[A](innerSelection: SelectionBuilder[PullRequest, A]): SelectionBuilder[AutoSquashEnabledEvent, Option[A]] =
