...
object AcceptEnterpriseAdministratorInvitationPayload {
  ...
  /** A unique identifier for the client performing the mutation.
    */
  def clientMutationId: SelectionBuilder[AcceptEnterpriseAdministratorInvitationPayload, Option[String]] =
  ...
  ): SelectionBuilder[AcceptEnterpriseAdministratorInvitationPayload, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("invitation", OptionOf(Obj(innerSelection)))

  /** A message confirming the result of accepting an administrator invitation.
    */
  def message: SelectionBuilder[AcceptEnterpriseAdministratorInvitationPayload, Option[String]] =
