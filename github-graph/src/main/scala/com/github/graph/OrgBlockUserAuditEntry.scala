...
object OrgBlockUserAuditEntry {
  ...
  ): SelectionBuilder[OrgBlockUserAuditEntry, Option[A]] = _root_.caliban.client.SelectionBuilder
    .Field("actor", OptionOf(ChoiceOf(Map("Bot" -> Obj(onBot), "Organization" -> Obj(onOrganization), "User" -> Obj(onUser)))))

  /** The IP address of the actor
    */
  def actorIp: SelectionBuilder[OrgBlockUserAuditEntry, Option[String]] = _root_.caliban.client.SelectionBuilder.Field("actorIp", OptionOf(Scalar()))

  /** A readable representation of the actor's location
    */
  def actorLocation[A](innerSelection: SelectionBuilder[ActorLocation, A]): SelectionBuilder[OrgBlockUserAuditEntry, Option[A]] =
  ...
  /** The HTTP path for the actor.
    */
  def actorResourcePath: SelectionBuilder[OrgBlockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("actorResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the actor.
    */
  def actorUrl: SelectionBuilder[OrgBlockUserAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("actorUrl", OptionOf(Scalar()))

  /** The blocked user.
    */
  def blockedUser[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[OrgBlockUserAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("blockedUser", OptionOf(Obj(innerSelection)))

  /** The username of the blocked user.
    */
  def blockedUserName: SelectionBuilder[OrgBlockUserAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("blockedUserName", OptionOf(Scalar()))

  /** The HTTP path for the blocked user.
    */
  def blockedUserResourcePath: SelectionBuilder[OrgBlockUserAuditEntry, Option[URI]] =
  ...
  /** The corresponding operation type for the action
    */
  def operationType: SelectionBuilder[OrgBlockUserAuditEntry, Option[OperationType]] =
    _root_.caliban.client.SelectionBuilder.Field("operationType", OptionOf(Scalar()))

  /** The Organization associated with the Audit Entry.
    */
  def organization[A](innerSelection: SelectionBuilder[Organization, A]): SelectionBuilder[OrgBlockUserAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("organization", OptionOf(Obj(innerSelection)))

  /** The name of the Organization.
    */
  def organizationName: SelectionBuilder[OrgBlockUserAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationName", OptionOf(Scalar()))

  /** The HTTP path for the organization
    */
  def organizationResourcePath: SelectionBuilder[OrgBlockUserAuditEntry, Option[URI]] =
  ...
  /** The user affected by the action
    */
  def user[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[OrgBlockUserAuditEntry, Option[A]] =
  ...
  /** The HTTP path for the user.
    */
  def userResourcePath: SelectionBuilder[OrgBlockUserAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("userResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the user.
    */
  def userUrl: SelectionBuilder[OrgBlockUserAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("userUrl", OptionOf(Scalar()))
  ...
  ): SelectionBuilder[OrgBlockUserAuditEntry, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
