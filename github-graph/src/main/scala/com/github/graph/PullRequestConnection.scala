...
object PullRequestConnection {
  ...
  /** A list of edges.
    */
  def edges[A](innerSelection: SelectionBuilder[PullRequestEdge, A]): SelectionBuilder[PullRequestConnection, Option[List[Option[A]]]] =
    _root_.caliban.client.SelectionBuilder.Field("edges", OptionOf(ListOf(OptionOf(Obj(innerSelection)))))

  /** A list of nodes.
    */
  def nodes[A](innerSelection: SelectionBuilder[PullRequest, A]): SelectionBuilder[PullRequestConnection, Option[List[Option[A]]]] =
