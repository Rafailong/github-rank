...
object RepoConfigDisableCollaboratorsOnlyAuditEntry {
  ...
  ): SelectionBuilder[RepoConfigDisableCollaboratorsOnlyAuditEntry, Option[A]] = _root_.caliban.client.SelectionBuilder
  ...
  ): SelectionBuilder[RepoConfigDisableCollaboratorsOnlyAuditEntry, Option[A]] =
  ...
  ): SelectionBuilder[RepoConfigDisableCollaboratorsOnlyAuditEntry, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
