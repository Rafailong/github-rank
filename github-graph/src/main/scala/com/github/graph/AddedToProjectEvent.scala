...
object AddedToProjectEvent {
  ...
  ): SelectionBuilder[AddedToProjectEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Identifies the primary key from the database.
    */
  def databaseId: SelectionBuilder[AddedToProjectEvent, Option[Int]] = _root_.caliban.client.SelectionBuilder.Field("databaseId", OptionOf(Scalar()))
  ...
  /** Project card referenced by this project event.
    */
  def projectCard[A](innerSelection: SelectionBuilder[ProjectCard, A]): SelectionBuilder[AddedToProjectEvent, Option[A]] =
