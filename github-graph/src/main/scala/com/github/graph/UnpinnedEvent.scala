...
object UnpinnedEvent {
  ...
  ): SelectionBuilder[UnpinnedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Identifies the issue associated with the event.
    */
  def issue[A](innerSelection: SelectionBuilder[Issue, A]): SelectionBuilder[UnpinnedEvent, A] =
