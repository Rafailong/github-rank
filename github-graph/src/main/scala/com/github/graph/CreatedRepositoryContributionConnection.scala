...
object CreatedRepositoryContributionConnection {
  ...
  ): SelectionBuilder[CreatedRepositoryContributionConnection, Option[List[Option[A]]]] =
  ...
  /** Information to aid in pagination.
    */
  def pageInfo[A](innerSelection: SelectionBuilder[PageInfo, A]): SelectionBuilder[CreatedRepositoryContributionConnection, A] =
    _root_.caliban.client.SelectionBuilder.Field("pageInfo", Obj(innerSelection))

  /** Identifies the total count of items in the connection.
    */
  def totalCount: SelectionBuilder[CreatedRepositoryContributionConnection, Int] =
