...
object AddLabelsToLabelablePayload {
  ...
  /** A unique identifier for the client performing the mutation.
    */
  def clientMutationId: SelectionBuilder[AddLabelsToLabelablePayload, Option[String]] =
  ...
  ): SelectionBuilder[AddLabelsToLabelablePayload, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "labelable",
