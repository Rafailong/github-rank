...
object RemoveReactionPayload {
  ...
  /** A unique identifier for the client performing the mutation.
    */
  def clientMutationId: SelectionBuilder[RemoveReactionPayload, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("clientMutationId", OptionOf(Scalar()))

  /** The reaction object.
    */
  def reaction[A](innerSelection: SelectionBuilder[Reaction, A]): SelectionBuilder[RemoveReactionPayload, Option[A]] =
  ...
  ): SelectionBuilder[RemoveReactionPayload, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "subject",
    OptionOf(
      ChoiceOf(
        Map(
