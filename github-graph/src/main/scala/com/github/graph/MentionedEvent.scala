...
object MentionedEvent {
  ...
  ): SelectionBuilder[MentionedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Identifies the primary key from the database.
    */
  def databaseId: SelectionBuilder[MentionedEvent, Option[Int]] = _root_.caliban.client.SelectionBuilder.Field("databaseId", OptionOf(Scalar()))
