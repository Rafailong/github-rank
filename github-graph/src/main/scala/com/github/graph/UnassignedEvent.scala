...
object UnassignedEvent {
  ...
  ): SelectionBuilder[UnassignedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  ): SelectionBuilder[UnassignedEvent, A] = _root_.caliban.client.SelectionBuilder
  ...
  def user[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[UnassignedEvent, Option[A]] =
  ...
  def assigneeOption[A](
    ...
    onOrganization: Option[SelectionBuilder[Organization, A]] = None,
    onUser: Option[SelectionBuilder[User, A]]                 = None
  ): SelectionBuilder[UnassignedEvent, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "assignee",
    OptionOf(
      ChoiceOf(
        Map(
