...
object LockedEvent {
  ...
  ): SelectionBuilder[LockedEvent, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** Reason that the conversation was locked (optional).
    */
  def lockReason: SelectionBuilder[LockedEvent, Option[LockReason]] = _root_.caliban.client.SelectionBuilder.Field("lockReason", OptionOf(Scalar()))
  ...
  ): SelectionBuilder[LockedEvent, A] = _root_.caliban.client.SelectionBuilder.Field(
    "lockable",
