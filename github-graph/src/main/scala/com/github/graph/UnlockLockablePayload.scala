...
object UnlockLockablePayload {
  ...
  ): SelectionBuilder[UnlockLockablePayload, Option[A]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
  ...
  /** A unique identifier for the client performing the mutation.
    */
  def clientMutationId: SelectionBuilder[UnlockLockablePayload, Option[String]] =
