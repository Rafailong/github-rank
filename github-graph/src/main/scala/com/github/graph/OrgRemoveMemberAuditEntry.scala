...
object OrgRemoveMemberAuditEntry {
  ...
  ): SelectionBuilder[OrgRemoveMemberAuditEntry, Option[A]] = _root_.caliban.client.SelectionBuilder
  ...
  /** A readable representation of the actor's location
    */
  def actorLocation[A](innerSelection: SelectionBuilder[ActorLocation, A]): SelectionBuilder[OrgRemoveMemberAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("actorLocation", OptionOf(Obj(innerSelection)))

  /** The username of the user who initiated the action
    */
  def actorLogin: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("actorLogin", OptionOf(Scalar()))

  /** The HTTP path for the actor.
    */
  def actorResourcePath: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[URI]] =
  ...
  /** The types of membership the member has with the organization.
    */
  def membershipTypes: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[List[OrgRemoveMemberAuditEntryMembershipType]]] =
    _root_.caliban.client.SelectionBuilder.Field("membershipTypes", OptionOf(ListOf(Scalar())))

  /** The corresponding operation type for the action
    */
  def operationType: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[OperationType]] =
    _root_.caliban.client.SelectionBuilder.Field("operationType", OptionOf(Scalar()))

  /** The Organization associated with the Audit Entry.
    */
  def organization[A](innerSelection: SelectionBuilder[Organization, A]): SelectionBuilder[OrgRemoveMemberAuditEntry, Option[A]] =
    _root_.caliban.client.SelectionBuilder.Field("organization", OptionOf(Obj(innerSelection)))

  /** The name of the Organization.
    */
  def organizationName: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[String]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationName", OptionOf(Scalar()))

  /** The HTTP path for the organization
    */
  def organizationResourcePath: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the organization
    */
  def organizationUrl: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("organizationUrl", OptionOf(Scalar()))

  /** The reason for the member being removed.
    */
  def reason: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[OrgRemoveMemberAuditEntryReason]] =
    _root_.caliban.client.SelectionBuilder.Field("reason", OptionOf(Scalar()))

  /** The user affected by the action
    */
  def user[A](innerSelection: SelectionBuilder[User, A]): SelectionBuilder[OrgRemoveMemberAuditEntry, Option[A]] =
  ...
  /** The HTTP path for the user.
    */
  def userResourcePath: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[URI]] =
    _root_.caliban.client.SelectionBuilder.Field("userResourcePath", OptionOf(Scalar()))

  /** The HTTP URL for the user.
    */
  def userUrl: SelectionBuilder[OrgRemoveMemberAuditEntry, Option[URI]] = _root_.caliban.client.SelectionBuilder.Field("userUrl", OptionOf(Scalar()))
  ...
  ): SelectionBuilder[OrgRemoveMemberAuditEntry, Option[Option[A]]] = _root_.caliban.client.SelectionBuilder.Field(
    "actor",
    OptionOf(
      ChoiceOf(
        Map(
